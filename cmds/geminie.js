    ...
    execute: async function ({ api, event, args, usersData }) {
        try {
            ...
            if (query) {
                ...
                const apiUrl = `https://liaspark.chatbotcommunity.ltd/@hercai/api/gemini?key=j86bwkwo-8hako-12C&userName=${encodeURIComponent(name || "a user")}&query=${encodeURIComponent(query)}`;
